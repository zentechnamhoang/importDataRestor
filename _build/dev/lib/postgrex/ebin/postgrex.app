{application,postgrex,
             [{registered,[]},
              ...
              {vsn,"0.11.1"},
              {modules,['Elixir.DBConnection.Query.Postgrex.Parameters',
                        'Elixir.DBConnection.Query.Postgrex.Query',
                        'Elixir.Postgrex','Elixir.Postgrex.App',
                        'Elixir.Postgrex.BinaryExtension',
                        'Elixir.Postgrex.BinaryUtils','Elixir.Postgrex.CIDR',
                        'Elixir.Postgrex.Date','Elixir.Postgrex.Error',
                        'Elixir.Postgrex.ErrorCode',
